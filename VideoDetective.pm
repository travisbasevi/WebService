...
#print $VD->artistdirect_id_to_external_source(50649);
#$VD->get_video(934065, "jay-z-hard-knock-life");
#use Data::Dumper; print Dumper($VD);
#print $VD->download;
...
sub get_video
	...
	if ($doc1 =~ /IVAPlayer.init\("ivadiv", *\{ *(.+?) *\}\);/s)
		...
		# check net conns: http://www.videodetective.com/music/the-13th/75872
