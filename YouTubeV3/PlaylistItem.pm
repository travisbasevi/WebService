package WebService::YouTubeV3::PlaylistItem;
...
Perhaps a little code snippet.
    ...
    my $yt = WebService::YouTubeV3::PlaylistItem->new();
    ...
...
sub _init
	...
	my $self = shift;
	$self->SUPER::_init(@_);
	$self->{url_base} = "https://www.googleapis.com/youtube/v3/playlistItems";
...
$playlist = $yt->fetch($playlist_id);
$playlist = $yt->fetch($playlist_id, [$part1, $part2]);
...
@pli = $yt->list(\@part, \%filter, \%optional, $limit);
